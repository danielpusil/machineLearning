...
public class FileParametersFactory extends AbstractParametersFactory {
	...
	private String path;
	/**
	 * File name that containts pameters with this specification: name of
	 * parameter-type of evaluation-name of algorithm-value
	 */
	private String fileName;

	public FileParametersFactory(String path, String fileName) throws Exception {
		values = new HashMap<>();
		this.path = path;
	 ...
	 */
	public void putParameter(String parameter, AbstractELMEvaluator.EvaluatorType evaluatorType, String algorithmName,
			double value) {
	 ...
	 */
	private String getKey(String parameter, AbstractELMEvaluator.EvaluatorType evaluatorType, String algorithmName) {
