...
public class Hill extends AbstractCrossValidationEvaluator {
	...
	public Hill() throws IOException {
		super(AbstractELMEvaluator.EvaluatorType.CV, "Hill", new DataSet("src/resources-elm", "hill.train", 100),
				new DataSet("src/resources-elm", "hill.test", 100), 10, 50, new Sigmoid(),
