...
public class Fertility extends AbstractCrossValidationEvaluator {
	...
	public Fertility() throws IOException {
		super(AbstractELMEvaluator.EvaluatorType.CV, "Fertility",
				new DataSet("src/resources-elm", "fertility.train", 9),
				new DataSet("src/resources-elm", "fertility.test", 9), 10, 50, new Sigmoid(),
