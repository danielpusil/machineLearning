...
public class SPECTF extends AbstractCrossValidationEvaluator {
	...
	public SPECTF() throws IOException {
		super(AbstractELMEvaluator.EvaluatorType.CV, "SPECTF", new DataSet("src/resources-elm", "SPECTF.train", 44),
				new DataSet("src/resources-elm", "SPECTF.test", 44), 10, 50, new Sigmoid(),
