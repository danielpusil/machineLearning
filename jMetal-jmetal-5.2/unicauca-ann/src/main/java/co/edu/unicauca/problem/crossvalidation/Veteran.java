...
public class Veteran extends AbstractCrossValidationEvaluator {
	...
	public Veteran() throws IOException {
		super(AbstractELMEvaluator.EvaluatorType.CV, "Veteran", new DataSet("src/resources-elm", "veteran.train", 7),
				new DataSet("src/resources-elm", "veteran.test", 7), 10, 50, new Sigmoid(),
